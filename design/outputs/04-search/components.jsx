...
const I18N = {
  ...
  // ── Signup / membership application ────────────────────────
  "signup.formno": "FORM MRM-101 · MEMBERSHIP APPLICATION",
  "signup.title": "Get your member card",
  "signup.subtitle": "★ free for life — bring your own snacks",
  "signup.label.email": "Email",
  "signup.label.password": "Pass code",
  "signup.label.confirm": "Confirm pass code",
  "signup.ph.email": "you@videostore.com",
  "signup.ph.password": "min. 8 characters",
  "signup.ph.confirm": "type it again",
  "signup.show": "SHOW",
  "signup.hide": "HIDE",
  "signup.strength.label": "Pass code strength",
  "signup.strength.0": "Enter a pass code",
  "signup.strength.1": "Weak — easily rewound",
  "signup.strength.2": "Fair — could be tighter",
  "signup.strength.3": "Good — tracking stable",
  "signup.strength.4": "Strong — vault-grade",
  "signup.match.ok": "Pass codes match",
  "signup.match.no": "Pass codes don't match",
  "signup.cta": "Issue my card",
  "signup.cta.loading": "Printing card…",
  "signup.divider": "or apply with",
  "signup.oauth.google": "Continue with Google",
  "signup.oauth.github": "Continue with GitHub",
  "signup.already": "Already a member?",
  "signup.signin": "Sign in here",
  "signup.error.head": "APPLICATION REJECTED",
  "signup.error.body": "That email is already on a card in our files. Try signing in instead.",
  "signup.success.head": "CARD ISSUED",
  "signup.success.body": "Welcome to the club. Printing your card and taking you to the counter…",
  "signup.legal": "Signature on file authorizes late fees. Member agrees to be kind and rewind.",
  "signup.clerk": "CLERK INITIALS ______   DATE 06 / 02 / 26",

  // ── Search / store directory terminal ──────────────────────
  "search.kicker": "Store Directory",
  "search.title": "Look up a title",
  "search.placeholder": "ENTER TITLE OR GENRE_",
  "search.clear": "CLEAR",
  "search.ch.all": "All channels",
  "search.ch.movies": "Movies",
  "search.ch.tv": "TV",
  "search.ch.anime": "Anime",
  "search.now.head": "Now showing — popular this week",
  "search.staff.head": "Staff picks",
  "search.staff.note": "★ video store classics",
  "search.results.head": "Found {n} results for",
  "search.results.sub": "SORTED BY RELEVANCE · TERMINAL 04",
  "search.zero.head": "Out of stock",
  "search.zero.sub": "Nothing on the shelf matches that title.",
  "search.zero.try": "OR TRY:",
  "search.zero.q": "the query",
  "search.error.head": "TERMINAL OFFLINE",
  "search.error.body": "The directory terminal lost its signal. Check the connection and search again.",
  "search.error.retry": "Retry search",
  "search.typing": "READING TAPE…",

  // popular row
  "search.pop.1.title": "Aliens",
  "search.pop.1.year": "1986",
  "search.pop.2.title": "The Terminator",
  "search.pop.2.year": "1984",
  "search.pop.3.title": "They Live",
  "search.pop.3.year": "1988",
  "search.pop.4.title": "Predator",
  "search.pop.4.year": "1987",
  "search.pop.5.title": "Re-Animator",
  "search.pop.5.year": "1985",
  "search.pop.6.title": "Tetsuo",
  "search.pop.6.year": "1989",

  // staff picks row
  "search.sp.1.title": "Solaris",
  "search.sp.1.year": "1972",
  "search.sp.2.title": "Stalker",
  "search.sp.2.year": "1979",
  "search.sp.3.title": "Fantastic Planet",
  "search.sp.3.year": "1973",
  "search.sp.4.title": "Angel's Egg",
  "search.sp.4.year": "1985",
  "search.sp.5.title": "Phase IV",
  "search.sp.5.year": "1974",

  // result grid for "ALIEN"
  "search.res.1.title": "Alien",
  "search.res.1.year": "1979",
  "search.res.2.title": "Aliens",
  "search.res.2.year": "1986",
  "search.res.3.title": "Alien³",
  "search.res.3.year": "1992",
  "search.res.4.title": "Alien Resurrection",
  "search.res.4.year": "1997",
  "search.res.5.title": "Prometheus",
  "search.res.5.year": "2012",
  "search.res.6.title": "Alien: Covenant",
  "search.res.6.year": "2017",
  "search.res.7.title": "Alien Nation",
  "search.res.7.year": "1988",
  "search.res.8.title": "Aliens vs Predator",
  "search.res.8.year": "2004"
};
