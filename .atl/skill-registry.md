...
- /home/jgarrone/.agents/skills
- /home/jgarrone/.config/opencode/skills
- /home/jgarrone/.claude/skills
- /home/jgarrone/.gemini/skills
...
### alpinejs
- Path: /home/jgarrone/.agents/skills/alpinejs/SKILL.md
- Trigger: AlpineJS best practices and patterns. Use when writing HTML with Alpine.js directives to avoid common mistakes like long inline JavaScript strings.
- Rules:
...
### branch-pr
- Path: /home/jgarrone/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/jgarrone/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/jgarrone/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/jgarrone/.config/opencode/skills/comment-writer/SKILL.md
...
### drizzle
- Path: /home/jgarrone/.agents/skills/drizzle/SKILL.md
- Trigger: Drizzle ORM schema and database guide. Use when working with database schemas (src/database/schemas/*), defining tables, creating migrations, or database model code. Triggers on Drizzle schema definition, database migrations, or ORM usage questions.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### find-skills
- Path: /home/jgarrone/.agents/skills/find-skills/SKILL.md
...
### go-testing
- Path: /home/jgarrone/.config/opencode/skills/go-testing/SKILL.md
...
- Path: /home/jgarrone/.agents/skills/internationalization-i18n/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /home/jgarrone/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/jgarrone/.config/opencode/skills/judgment-day/SKILL.md
...
### nextjs-15
- Path: /home/jgarrone/.agents/skills/nextjs-15/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### nextjs-frontend-testing
- Path: /home/jgarrone/.agents/skills/nextjs-frontend-testing/SKILL.md
- Trigger: Use this skill whenever the user wants to set up, improve, or run frontend tests (unit, component, and E2E) for a Next.js (App Router) + TypeScript + Tailwind + shadcn/ui project using Vitest/Jest, React Testing Library, and Playwright.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-query
- Path: /home/jgarrone/.agents/skills/react-query/SKILL.md
- Trigger: Guidelines for using React Query for data fetching, caching, and server state synchronization in React applications
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/jgarrone/.config/opencode/skills/skill-creator/SKILL.md
...
### supabase
- Path: /home/jgarrone/.agents/skills/supabase/SKILL.md
...
- Path: /home/jgarrone/.agents/skills/tailwind-design-system/SKILL.md
...
### ui-design-system
- Path: /home/jgarrone/.agents/skills/ui-design-system/SKILL.md
- Trigger: React UI component systems with TailwindCSS + Radix + shadcn/ui. Stack: TailwindCSS (styling), Radix UI (primitives), shadcn/ui (components), React/Next.js. Capabilities: design system architecture, accessible components, responsive layouts, theming, dark mode, component composition. Actions: review, design, build, improve, refactor UI components. Keywords: TailwindCSS, Radix UI, shadcn/ui, design system, component library, accessibility, ARIA, responsive, dark mode, theming, CSS variables, component architecture, atomic design, design tokens, variant, slot, composition. Use when: building component libraries, implementing shadcn/ui, creating accessible UIs, setting up design systems, adding dark mode/theming, reviewing UI component architecture.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/jgarrone/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zustand
- Path: /home/jgarrone/.agents/skills/zustand/SKILL.md
- Trigger: Zustand state management guide. Use when working with store code (src/store/**), implementing actions, managing state, or creating slices. Triggers on Zustand store development, state management questions, or action implementation.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
