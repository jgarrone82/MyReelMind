...
export function OAuthButtons({ dict }: OAuthButtonsProps) {
  ...
  return (
    <div className="flex flex-col gap-3.5">
      <button
        ...
        className={`${OAUTH_CARD_CLASS} -rotate-[1.5deg]`}
      >
        <GoogleMark />
