...
function buildHref(lang: string, status: string | null, type: string | null): string {
...
export function TypeFilterChips({ lang, currentType, currentStatus, dict }: TypeFilterChipsProps) {
  return (
