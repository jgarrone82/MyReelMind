...
export const dictionary: Dictionary = {
  ...
  auth: {
    ...
    signup: {
      ...
      errorBody:
        "That email is already on a card in our files. Try signing in instead.",
      already: "Already a member?",
      signin: "Sign in here",
      finePrint:
        "Signature on file authorizes late fees. Member agrees to be kind and rewind.",
    },
    logout: "Sign out",
    errors: {
    ...
    passwordReset: {
      ...
      kicker: "REWIND & RECOVER",
      headline: "RESET YOUR TAPE",
      subtitle: "ENTER YOUR MEMBER ID TO PROCEED",
      finePrint: "Valid reset links expire in 60 minutes. Be kind, rewind your password.",
      errorHeadline: "TAPE ERROR",
      loadingTape: "REWINDING...",
    },
    emailVerification: {
      ...
      verifySubtitle: "CHECK YOUR INBOX TO ACTIVATE YOUR ACCOUNT",
      sentSubtitle: "DIDN'T ARRIVE? REWIND AND RESEND BELOW",
      finePrint: "Verification links expire in 24 hours. Need help? Rewind to support.",
      errorHeadline: "SIGNAL LOST",
      loadingTape: "TRANSMITTING...",
      verifyKicker: "YOUR MEMBERSHIP",
      sentKicker: "VERIFICATION SENT",
